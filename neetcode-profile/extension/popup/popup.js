...
// Username input — only allow lowercase alphanumeric, hyphen, underscore
...
$("publishBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    // Backend not deployed yet — show preview link
    await chrome.storage.local.set({ savedUsername: username, published: true });
    showLink(username);
    $("publishBtn").textContent  = "✅ Preview Ready";
    $("publishHint").textContent = "⚠️ Deploy backend to make it live.";
  }
});
